...
export class AppComponent implements OnInit {
  ...
  title: string = 'Live Resume - Werner Swanepoel';
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: "Hello, I'm a Full-stack Web Developer with 10+ years of experience designing web and mobile projects. Find out more in my curriculum-vitae!" }
    );
  }
}
